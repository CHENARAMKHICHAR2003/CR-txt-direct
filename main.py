...
keyboard = InlineKeyboardMarkup(
    [
        [
            InlineKeyboardButton(text="📞 Contact", url="https://t.me/courses_hub2_bot"),
            InlineKeyboardButton(text="🛠️ Help", url="https://t.me/courses_hub2_bot"),
        ],
    ]
)
...
async def start_command(bot: Client, message: Message):
    ...
    caption = (
        "𝐇𝐞𝐥𝐥𝐨 𝐃𝐞𝐚𝐫 👋✅🎁!\n\n➠ 𝐈 𝐚𝐦 𝐚 𝐓𝐞𝐱𝐭 𝐃𝐨𝐰𝐧𝐥𝐨𝐚𝐝𝐞𝐫 𝐁𝐨𝐭 with text file \n\n➠ Can Extract Videos & PDFs From Your Text File and Upload to Telegram!\n\n➠ For Guide Use Command /help 📖\n\n➠ POWDERED BY CR CHOUDHARY ❤️"
    )
...
async def txt_handler(client: Client, m: Message):
    await bot.send_message(m.chat.id, text= (
        ...
        f"╭────────⊰◆⊱────────╮\n"   
        f" ➠ 𝐌𝐚𝐝𝐞 𝐁𝐲 : [CR CHOUDHARY](https://t.me/courses_hub2_bot) 💻\n"
        f"╰────────⊰◆⊱────────╯\n"
        )
    )                    
...
async def txt_handler(bot: Client, m: Message):  
    ...
    if raw_text3 == '1':
        CR = '[𝄟⃝‌🐬CR CHOUDHARY𝄟⃝🐬](https://t.me/courses_hub2_bot)'
    else:
        CR = raw_text3
            ...
            try:
                ...
                if "drive" in url:
                    ...
                    Show = f"🚀𝐏𝐫𝐨𝐠𝐫𝐞𝐬𝐬 » {progress:.2f}%\n┃\n" \
                           ...
                           f"╰━✦𝐁𝐨𝐭 𝐌𝐚𝐝𝐞 𝐁𝐲 ✦ [CR  𝘽𝙊𝙏𝙎🐦](https://t.me/courses_hub2_bot)"
